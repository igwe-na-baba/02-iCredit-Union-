                    ...
                    <div>
                        ...
                        <div className="text-sm text-slate-500 flex items-center space-x-2">
                           {recipient.nickname ? (
                                ...
                                <>
                                    {InlineBankLogo && <InlineBankLogo className="w-4 h-4 object-contain rounded-sm" />}
                                        ...
                                        <div className="not-italic p-4 rounded-lg shadow-digital-inset text-slate-700 text-sm leading-relaxed space-y-2">
                                            ...
                                            {recipient.streetAddress && (
                                                <address className="not-italic">
                                                    ...
                                                    {recipient.streetAddress}<br />
                                                    {recipient.city}, {recipient.stateProvince} {recipient.postalCode}<br />
