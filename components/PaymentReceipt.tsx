    ...
    return (
        <>
            ...
            <div className="relative z-10 text-left space-y-6 animate-fade-in-up">
                {isCompleted && (
                    <img src="https://i.imgur.com/eB4kH1g.png" alt="Paid Stamp" className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 h-auto opacity-20 transform -rotate-12 pointer-events-none" />
                )}
                    ...
                    <Section title="Authorization">
                         <div className="flex justify-between items-end">
                             <div className="text-left">
                                <img src={`https://api.qrserver.com/v1/create-qr-code/?size=100x100&data=iCU-Txn-${transaction.id}&bgcolor=0f172a&color=e2e8f0&qzone=1`} alt="Transaction QR Code" className="w-24 h-24 rounded-lg bg-slate-900 p-1 border border-slate-700" />
                                <p className="text-xs text-slate-500 mt-1">Scan for details</p>
                             </div>
                             <div className="text-center relative w-48 h-24">
                                <img src="https://i.imgur.com/8Q9g2o4.png" alt="Signature" className="absolute top-0 left-1/2 -translate-x-1/2 w-32 h-auto mix-blend-screen opacity-70" />
