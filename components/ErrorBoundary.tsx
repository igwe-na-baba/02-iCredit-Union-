...
export class ErrorBoundary extends Component<Props, State> {
  // FIX: Initializing state as a class property. The constructor-based initialization was causing type errors where 'this.state' and 'this.props' were not being recognized on the class instance.
