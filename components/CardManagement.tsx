...
// FIX: Add missing CardManagementProps interface.
...
const ViewCardDetailsModal: React.FC<{ card: Card; onClose: () => void }> = ({ card, onClose }) => (
...
export const CardManagement: React.FC<CardManagementProps> = ({ cards, cardTransactions, onUpdateCardControls, onAddCard, accountBalance, onAddFunds }) => {
    ...
    return (
        <>
                        ...
                        {currentCard && (
                            <>
                                ...
                                <div className="bg-slate-200 rounded-2xl shadow-digital grid grid-cols-3 gap-2 text-center p-2">
                                    <button onClick={() => setShowDetailsModal(true)} className="flex flex-col items-center p-2 rounded-lg hover:bg-slate-300/50">
            ...
            {showDetailsModal && currentCard && <ViewCardDetailsModal card={currentCard} onClose={() => setShowDetailsModal(false)} />}
